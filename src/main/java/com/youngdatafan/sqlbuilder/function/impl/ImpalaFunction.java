 ...
 */
public class ImpalaFunction extends AbstractDatabaseFunctionAbstract {
    ...
    public String addDateTime(AbstractFunction abstractFunction) {
        ...
        switch (timeUnitType) {
            ...
            default:
                throw new SQLBuildException("impala暂不支持该" + timeUnitType.getCode() + "时间单位加减");
        }
    }
    ...
    public String dateDiff(AbstractFunction abstractFunction) {
        ...
        switch (timeUnitType) {
            ...
            default:
                throw new SQLBuildException("impala暂不支持" + timeUnitType.getCode() + "时间单位间隔");
        }
    }
}
