...
public enum FunctionType {
    ...
    PERCENTAGE_NUM("percentage_num", "百分比转数值"),
    NUM_PERCENTAGE("num_percentage", "数值转百分比"),
    NOT("not", "取反"),
    E("e", "e的值"),
    PI("pi", "pi的值"),
    EXP("exp", "e的X次方"),
    ...
    MUL_POLYM("mul_polym", "乘积聚合"),
    QUANTILE("quantile", "分位数"),
    FOUR_QUANTILE("four_quantile", "四分位数"),
    STANDARD_ERROR("standard_error", "标准误差"),
    STDDEV_POP("stddev_pop", "总体标准差"),
    VAR_POP("var_pop", "总体方差"),
    COVAR_POP("covar_pop", "协方差"),
    CORRELATION_COEFFICIENT("correlation_coefficient", "相关系数"),
    SUM_SQUARES("sum_squares", "平方和"),
    SUM_WEIGHT("sum_weight", "权重和"),
    MAX_FREQUENCY("max_frequency", "众数"),
